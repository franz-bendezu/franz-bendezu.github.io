...
export const PROJECTS: IBaseProject[] = [
  ...
  },
  {
    ...
    technologyCodes: ["aws-s3", "java", "mariadb", "spring-boot", "vue"],
  },
  {
    status: "completed",
    ...
    categoryCode: "freelance",
    technologyCodes: ["nodejs", "prisma", "aws-lambda", "github-actions", "mjml"],
  },
  {
    status: "completed",
    ...
    tags: ["Amplify", "Amazon RDS", "EC2", "S3", "Spring Framework", "Java", "Vue.js"],
    image: {
  ...
  },
  {
    ...
    tags: ["Spring Boot", "JPA Hibernate", "Java", "TypeScript", "Vue.js", "Vuetify", "Nginx", "Docker"],
    image: {
      src: "/images/order-management.jpg",
      alt: "Sistema de Gestión de Cotizaciones y Órdenes",
    },
    categoryCode: "freelance",
    technologyCodes: ["spring-boot", "jpa-hibernate", "java", "typescript", "vue", "vuetify", "nginx", "docker"],
  },
  {
    status: "completed",
    ...
    categoryCode: "freelance",
    technologyCodes: ["react", "javascript", "html", "css", "wordpress"],
  },
];
