    ...
    projectGoals: [
      {
        ...
        description:
          "Desarrollar una aplicación para encontrar lugares cercanos donde alquilar oxímetros para la detección de COVID-19.",
      },
      {
        title: "Respuesta a la Pandemia",
        description:
          "Responder a la creciente demanda de oxímetros durante la pandemia de COVID-19 en Perú.",
      },
      {
        title: "Desarrollo Rápido y Eficiente",
        description:
          "Utilizar tecnologías modernas para un desarrollo rápido y eficiente del MVP.",
      },
    ],
    keyFeatures: [
      {
        ...
        description:
          "Visualización de tiendas cercanas donde alquilar oxímetros para la detección de COVID-19.",
      },
      {
        title: "Geolocalización",
        description:
          "Integración de Leaflet.js para la visualización de mapas y geolocalización.",
      },
      {
        title: "Desarrollo Ágil",
        description:
          "Desarrollo rápido y eficiente utilizando Vue.js y Firebase.",
      },
    ],
  },
  {
