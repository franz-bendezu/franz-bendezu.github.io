  ...
  projectGoals: [
    {
      ...
      description:
        "Integrate a custom Google Maps style and improve the UI/UX for the quoting process.",
    },
    {
      title: "Improve Continuous Delivery Process",
      description:
        "Migrate an iframe to a WordPress plugin for better update management.",
    },
    {
      title: "Facilitate Lead Capture",
      description:
        "Develop functions to capture leads and audit data.",
    },
  ],
  keyFeatures: [
    {
      title: "Custom Google Maps Style",
      description:
        "Integration of a custom Google Maps style for a better user experience.",
    },
    {
      title: "Ease of Maintenance and Updates",
      description:
        "Migration of an iframe to a WordPress plugin for better update management.",
    },
    {
      title: "Lead Capture",
      description:
        "Development of functions to capture leads and audit data.",
    },
  ],
  images: [
    {
      src: "/images/movify-quote-system-improvement/step-1.webp",
      alt: "Step 1",
      description: "New step to fill in customer data.",
    },
    {
      src: "/images/movify-quote-system-improvement/step-2.webp",
      alt: "Step 2",
      description: "New step to fill in moving data.",
    },
    {
      src: "/images/movify-quote-system-improvement/step-3.webp",
      alt: "Step 3",
      description: "New step to fill in items to be moved.",
    },
    {
      src: "/images/movify-quote-system-improvement/step-4.webp",
      alt: "Step 4",
      description:
        "New step to show the price of moving options.",
    },
    {
      src: "/images/movify-quote-system-improvement/step-5.webp",
      alt: "Step 5",
      description: "New step to show additional services.",
    },
  ],
};
